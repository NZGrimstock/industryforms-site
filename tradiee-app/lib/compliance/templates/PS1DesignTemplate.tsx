...
export const PS1DesignTemplate = ({
  statement,
  profile,
  signature,
}: {
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(HeaderBar, { formCode: 'Producer statement design (PS1)', formTitle: '', psNumber, user: profile }),
      ...
      React.createElement(InstructionBanner, {
        text: 'TO BE COMPLETED BY THE DESIGN PROFESSIONAL WHO HAS BEEN ENGAGED TO PROVIDE A PS1',
      }),
      ...
      React.createElement(View, { style: base.body },
        ...
        React.createElement(View, { style: [base.fieldRow, { alignItems: 'flex-start', minHeight: 28 }] },
          React.createElement(Text, { style: base.fieldLabel }, 'To provide design services in respect of: (describe work)'),
          React.createElement(View, { style: [base.fieldValue, { paddingTop: 3 }] },
            React.createElement(View, { style: { flexDirection: 'row', alignItems: 'center', gap: 12, marginBottom: 4 } },
              React.createElement(View, { style: { flexDirection: 'row', alignItems: 'center', gap: 3 } },
                React.createElement(View, { style: [base.checkBox, d.designServiceScope === 'part' ? base.checkBoxChecked : {}] }),
                React.createElement(Text, { style: { fontSize: 8.5, color: '#1a1a1a' } }, 'Part'),
              ),
              React.createElement(View, { style: { flexDirection: 'row', alignItems: 'center', gap: 3 } },
                React.createElement(View, { style: [base.checkBox, d.designServiceScope === 'all' ? base.checkBoxChecked : {}] }),
                React.createElement(Text, { style: { fontSize: 8.5, color: '#1a1a1a' } }, 'All'),
              ),
            ),
            React.createElement(Text, { style: { fontSize: 8.5, color: '#1a1a1a', lineHeight: 1.4 } }, (d.workDescription || d.descriptionOfWork || '') as string),
          ),
        ),
        ...
        React.createElement(View, { style: { marginTop: 8 } },
          ...
          React.createElement(CheckItem, {
            ...
            checked: d.complianceMethod === 'MBIE',
          }),
          React.createElement(CheckItem, {
            label: 'Alternative solution (attach schedule if required)',
            checked: d.complianceMethod === 'alternative',
          }),
        ),

        React.createElement(View, { style: base.declarationBox },
          React.createElement(Text, { style: base.declarationText },
            'The proposed building work covered by this producer statement design is described on the drawings referenced below, together with the specifications and other documents set out in the schedule attached to this statement:',
          ),
        ),

        React.createElement(FieldRow, { label: 'Drawings:', value: (d.drawings || d.drawingTitle) as string }),
        ...
        React.createElement(FieldRow, { label: '(i) Site verification of the following design assumptions:', value: (d.siteVerificationDetails || d.siteVerification) as string }),
        React.createElement(View, { style: { marginTop: 3 } },
          React.createElement(Text, { style: base.declarationText }, '(ii) All proprietary products meeting their performance specification requirements'),
        ),

        React.createElement(View, { style: { marginTop: 6 } },
          React.createElement(Text, { style: base.declarationText }, 'Construction monitoring is:'),
          React.createElement(CheckItem, { label: 'Not required', checked: d.constructionMonitoring === 'not_required' }),
          React.createElement(CheckItem, { label: 'Required (if required please list below)', checked: d.constructionMonitoring === 'required' }),
        ),
        React.createElement(FieldRow, { label: '(Agreement must be attached)', value: d.monitoringDetails as string }),

        React.createElement(View, { style: base.declarationBox },
          React.createElement(Text, { style: base.declarationText },
            'I believe on reasonable grounds that the proposed building work, will comply with the relevant provisions of the Building Code if constructed in accordance with the drawings, specifications and other documents provided or listed with this statement.',
          ),
          React.createElement(Text, { style: base.declarationText },
